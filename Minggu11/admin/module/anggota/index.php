                        ...
                        <form action="fungsi/tambah.php?anggota=tambah" method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="recepient-name">
                                </div>
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-form-label">Jabatan : </label>
                                    <select name="jabatan" class="form-select" name aria-label="Default select example">
