<?php
    ...
    echo "Peningkatan jarak harian: $peningkatanHarian km/hari <br>";
    ...
    echo "Jumlah tanaman / lahan : $tanamanPerLahan <br>";
    echo "Jumlah buah / tanaman : $buahPerTanaman <br>";
    ...
    for ($i=0; $i < count($skorUjian) ; $i++) { 
        ...
        echo "Skor ke-" . ($i + 1) . ": $skorUjian[$i] <br>";
    }
