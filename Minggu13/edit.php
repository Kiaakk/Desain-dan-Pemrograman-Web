...
<html>
    ...
    <body>
        <?php
            include('koneksi.php'); // Pastikan file koneksi menggunakan sqlsrv_connect
            $id = $_GET['id'];
            ...
            <form action="proses.php?aksi=ubah" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="jenis_kelamin" id="laki" value="L" <?php if ($row['jenis_kelamin'] === 'L') echo 'checked'; ?> required>
                        <label class="form-check-label" for="laki">Laki-laki</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" class="form-check-input" name="jenis_kelamin" id="perempuan" value="P" <?php if ($row['jenis_kelamin'] === 'P') echo 'checked'; ?> required>
